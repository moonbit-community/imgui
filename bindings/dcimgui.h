...
#include "upstream/imgui/imconfig.h"  //-----------------------------------------------------------------------------
...
CIMGUI_API void ImGui_PushStyleColorImVec4Ptr(ImGuiCol idx, ImVec4* col);
...
CIMGUI_API void ImGui_PushStyleVarImVec2Ptr(ImGuiStyleVar idx, ImVec2* val);  // modify a style ImVec2 variable. "
...
CIMGUI_API bool                  ImGui_IsRectVisibleImVec2Ptr(ImVec2* rect_min, ImVec2* rect_max);  // test if rectangle (in screen space) is visible / not clipped. to perform coarse clipping on user's side.
...
CIMGUI_API void ImFontAtlas_SetTexIDImTextureRefPtr(ImFontAtlas* self, ImTextureRef* id);  // Called by legacy backends.
...
CIMGUI_API void   ImGui_ImageImVec4Ptr(ImTextureRef* tex_ref, ImVec2* image_size, ImVec2* uv0, ImVec2* uv1, ImVec4* tint_col, ImVec4* border_col); // <-- 'border_col' was removed in favor of ImGuiCol_ImageBorder. If you use 'tint_col', use ImageWithBg() instead.
